...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!db) {
        throw new Error(
          "Form submission is unavailable until Firebase is configured.",
        );
      }
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Ready to transform emergency response in Birmingham? We'd love to
              hear from you. Reach out to schedule a demo, explore partnerships,
              or learn more about how Mesh can help your agencies.
            </p>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Serving all of Jefferson County and beyond
                  </p>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Quick answers to common questions about Mesh
            </p>
          </motion.div>
